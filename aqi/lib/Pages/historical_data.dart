...
class _HistoricalDataPageState extends State<HistoricalDataPage>
  ...
  final List<String> timeLabels = [
    '15:42', '15:47', '15:52', '15:57', '16:02', '16:07'
  ];
  ...
  final List<Color> _colors = [
    ...
    Colors.purple, // Pressure
    Colors.teal, // Altitude
    Colors.amber, // PM2.5
  ];

  final List<double> _maxYValues = [
    1.5, // NO2
    20, // CO
    4, // NH3
    40, // Temperature
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Air & Environmental Quality'),
      ),
      body: Column(
        children: [
          Expanded(
  ...
  String _getChartTitle(int index) {
    switch (index) {
      case 0:
        return 'NO₂ Levels Over Time';
      case 1:
        return 'CO Levels Over Time';
      case 2:
        return 'NH₃ Levels Over Time';
      case 3:
        return 'Temperature Over Time';
      case 4:
        return 'Pressure Over Time';
      case 5:
        return 'Altitude Over Time';
      case 6:
        return 'PM2.5 Levels Over Time';
      default:
        return '';
    }
  }
                ...
                lineBarsData: [
                  LineChartBarData(
                    spots: spots
                        .map((spot) => FlSpot(
                      spot.x,
                      isAnimated ? spot.y * _controller.value : spot.y,
                    ))
                        .toList(),
                    isCurved: true,
                    color: color,
